...
add wave -noupdate /tb_datapath/dut/writedata
...
add wave -noupdate -radix hexadecimal /tb_datapath/correct_answer
add wave -noupdate -divider -height 40 REGISTER_BANK
add wave -noupdate /tb_datapath/dut/REGISTER_BANK/write
add wave -noupdate /tb_datapath/dut/REGISTER_BANK/rs1
add wave -noupdate /tb_datapath/dut/REGISTER_BANK/rs2
add wave -noupdate /tb_datapath/dut/REGISTER_BANK/rd
...
update
WaveRestoreZoom {7735 ps} {7831 ps}
