...
#define SPI_Status              *(volatile unsigned long *)(0x00408024)  
#define SPI_Data                *(volatile unsigned long *)(0x00408028)  
#define SPI_Ext                 *(volatile unsigned long *)(0x0040802C)  
#define SPI_CS                  *(volatile unsigned long *)(0x00408030)  
