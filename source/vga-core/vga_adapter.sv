 ...
 * - MONOCHROME - a string that should be "TRUE" if you only want grayscale colours, and "FALSE"
 *                otherwise.
...
module vga_adapter(
	...
	/* Set this parameter to "TRUE" if you only wish to use gray colours. Doing so will reduce
	...
	/* The colour input can be either BITS_PER_COLOUR_CHANNEL or 3*BITS_PER_COLOUR_CHANNEL bits wide, depending on
	 * the setting of the MONOCHROME parameter.
	 */
	input [((MONOCHROME == "TRUE") ? (BITS_PER_COLOUR_CHANNEL-1) : (BITS_PER_COLOUR_CHANNEL*3-1)):0] colour;
	...
	wire [((MONOCHROME == "TRUE") ? (BITS_PER_COLOUR_CHANNEL-1) : (BITS_PER_COLOUR_CHANNEL*3-1)):0] to_ctrl_colour;
	...
	defparam
		VideoMemory.width_a = ((MONOCHROME == "FALSE") ? (BITS_PER_COLOUR_CHANNEL*3) : BITS_PER_COLOUR_CHANNEL),
		VideoMemory.width_b = ((MONOCHROME == "FALSE") ? (BITS_PER_COLOUR_CHANNEL*3) : BITS_PER_COLOUR_CHANNEL),
